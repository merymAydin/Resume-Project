        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nationality = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Turkish"),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    isActive = table.Column<bool>(type: "bit", nullable: false),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.InsertData(
                table: "languages",
                columns: new[] { "Id", "CreateAt", "Level", "Name", "UpdateAt", "isActive", "isDeleted" },
                values: new object[,]
                {
                    { new Guid("32fa93bd-8f5d-4830-8fd0-1dce0190a5f9"), new DateTime(2025, 7, 25, 14, 55, 41, 393, DateTimeKind.Local).AddTicks(7655), (byte)80, "İngilizce", null, true, false },
                    { new Guid("57c2e6cc-ed3c-4783-aa0f-588c8a885882"), new DateTime(2025, 7, 25, 14, 55, 41, 393, DateTimeKind.Local).AddTicks(7696), (byte)30, "Almanca", null, true, false }
                });
        }
